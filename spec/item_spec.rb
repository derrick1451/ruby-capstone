...
describe Item do
  ...
  it 'should have a valid genre (not nil)' do
    expect(@an_item.genre.nil?).to be_truthy
  end

  it 'should have a valid author (not nil)' do
    expect(@an_item.author.nil?).to be_truthy
  end

  it 'should have a valid label (not nil)' do
    expect(@an_item.label.nil?).to be_truthy
  end

  it 'should have a valid publish_date (not nil)' do
    expect(@an_item.published_date.nil?).to be_falsy
  end
  ...
  it 'move_to_archive sets archived to true if can_be_archive?' do
    ...
    expect(@an_item.archived).to be_falsy
  end
end